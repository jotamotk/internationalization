export default {
  ...
  countdown: {
    ...
    sendText: 'Re-send in {0}s',
  },
  cropper: {
    selectImage: 'Select Image',
    uploadSuccess: 'Your profile picture has been successfully updated.',
    modalTitle: 'Avatar upload',
    okText: 'Confirm and upload',
    btn_reset: 'Reset',
    btn_rotate_left: 'Rotate counterclockwise',
    btn_rotate_right: 'Rotate clockwise',
  ...
  upload: {
    ...
    startUpload: 'Start to upload',
    uploadSuccess: 'Uploaded successfully',
    uploadError: 'Uploaded failed',
    uploading: 'Uploading',
    uploadWait: 'Please wait for the file upload',
