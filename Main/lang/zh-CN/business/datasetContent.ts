export default {
  MyCloud: '我的云存储',
  BucketName: '存储桶名称',
  CloudTips: '请选择一个云存储提供商并选择一个路径。',
  CloudPathTips: '请点击下方的文件以获取路径。',
  pathPlaceholder: '请点击下方的文件以获取路径。',
  ViewStorage: '查看存储',
  name: '名称',
  url: 'URL',
  data: '数据',
  ...
  localData: '本地数据',
  objectStorage: '对象存储',
  basicAiStorage: "Basic AI的云存储",
  myCloudStorage: '我的云存储',
  dataType: '数据类型',
  uploadDate: '上传时间',
  ...
  uploadModel: {
    ResultNameEmpty: '结果名称不能为空',
    ResultNameMorethan255: '结果名称不能超过255个字符',
    ResultNameDuplicated: '结果名称不能重复',
    uploadConfig: '上传配置',
    pathPlaceholder: '请输入路径，例如/目录/测试.rar或测试.rar',
    cloudPlaceholder: '请选择',
    // 0
    and: '和',
    uploadResult: ' 如何上传带结果的数据',
    checkTip: '请查阅我们的文档以了解如何配置和上传数据',
    // 1
    uploadLocalData: '上传本地数据',
    clickText: '点此选择文件，',
    dragText: '或拖拽文件到这里',
    compressedFiles: '仅支持压缩文件（zip/gzip/tar/rar）。',
    selectedHolder: '您已选择 {num} 个文件。',
    reSelectHolder: '点击或拖放以重新选择文件',
    widthText: ' ',
    formatText: ' 3D数据需满足支持的文件格式',
    widthSupported: ' ',
    checkText: '查看帮助文档：',
    checkImageText: '查看帮助文档：支持的数据格式',
    uploadImageSupportTip: '仅支持图像文件 (.jpg/.jpeg/.png/.bmp/.tiff/.webp) 或包含有效图像类型的压缩文件 (.zip/.gzip/.tar/.rar)。',
  ...
  dataConfig: {
    ...
    DataFormat: '格式',
    formatTip:
      '数据和标注格式是 Basic AI 用于组织您在 zip 文件中所有文件夹中的数据和标注的规则',
    annotationstTip: ' 是否以及哪里你想导入标注结果',
  },
  sort: {
    itemName: '数据名称',
    createDate: '创建时间',
  ...
  export: {
    zipFileNameValidator: '压缩包文件名不能为空',
    createAnExport: '创建导出',
    annotations: '标注结果',
    AnnotationResource: '标注来源',
    Annotationformat: '标注格式',
    OnlyexportData: '只导出有结果的数据',
    expectRawData: '导出原始数据',
    dataRange: '数据范围',
    dataFormat: '数据格式',
    data: '数据',
    zipFileName: '压缩包名称',
    ...
    Done: '完成',
    deleteTitle: '删除导出记录？',
    deleteTips: '您将要删除一个导出记录，此操作不可撤销，是否继续？',
    },
};
