export default {
  ...
  api: {
    ...
    apiTip:
      'API keys have the potential to perform dangerous operations. Exercise caution when sharing your API key with others or when exposing it in the browser. Note that once generated, your secret API keys will not be displayed again.',
    emptyApi: "You don't have any API Keys. Do you want to create one?",
    createAPIKey: 'Create a API Key',
    APIKeyName: 'API Key Name',
    expirationDate: 'Expiration Date',
    neverExpired: 'Never Expires',
    createAPITip:
      'Please be aware that your secret API keys will not be displayed again once this dialog is closed. Ensure you have copied them.',
    newApiKey: '🎉 Your New API Key',
  },
  storage: {
    cloudStorage: 'Cloud Storage',
    storageTip:
      'You can integrate and manage your Cloud Storage here. Your credentials are secure with us and will only be used for data upload and export.',
    emptyStorage: "You don't have any Cloud Storage. Do you want to create one?",
    deleteCloudStorage: 'Delete a Cloud Storage?',
    deleteStorageTip:
      'You are about to delete a Cloud Storage. This action is irreversible. Do you wish to proceed?',
    cloudStorageProfile: 'Cloud Storage Profile',
    cloudStorageName: 'Cloud Storage Name',
    storageName: 'Storage name',
    duplicateStorage: 'Each Cloud Storage name must be unique',
    overStorage: 'The Cloud Storage name cannot exceed 255 characters',
    provider: 'Provider',
    providerList: {
      amazonS3: 'Amazon S3',
    ...
    failedToFetch: 'Failed to fetch your {drive} authentication. Please try again.',
    failedToConnect: 'Failed to connect with your cloud. Please check your credentials',
